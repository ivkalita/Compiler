	...
	//TODO: DC
{
	...
	{
		$baseCSSPath      = self::$assetsPath . "/Jit/base.css";
		$spaceTreeCSSPath = self::$assetsPath . "/Jit/Spacetree.css";
		$jitPath          = self::$assetsPath . "/Jit/jit.js";
		$excanvasPath     = self::$assetsPath . "/Jit/excanvas.js";
		$jsPath           = "$name.js";
		$js = 
